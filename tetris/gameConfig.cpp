...
const int GameConfig::NUM_OF_COLORS = 13;
...
const char GameConfig::VALID_LEFT_KEYS[] = { (char)LKeys::LEFT_LOWER, (char)LKeys::RIGHT_LOWER, (char)LKeys::ROTATE_CLOCKWISE_LOWER,
		...
		(char)LKeys::ROTATE_CLOCKWISE_UPPER, (char)LKeys::ROTATE_COUNTERCLOCKWISE_UPPER, (char)LKeys::DROP_UPPER, (char)LKeys::DO_NOTHING, (char)LKeys::ESC};
...
const char GameConfig::VALID_RIGHT_KEYS[] = { (char)RKeys::LEFT_LOWER, (char)RKeys::RIGHT_LOWER, (char)RKeys::ROTATE_CLOCKWISE_LOWER,
	...
	(char)RKeys::ROTATE_CLOCKWISE_UPPER, (char)RKeys::ROTATE_COUNTERCLOCKWISE_UPPER, (char)RKeys::DROP_UPPER, (char)RKeys::DO_NOTHING, (char)RKeys::ESC };
